...
{
    public class ValidateAddOnCardsService : IValidateAddOnCardsService
    {
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly IRequestService _requestService;
        private readonly ICommonActionService _commonActionService;

        public ValidateAddOnCardsService(IHttpContextAccessor httpContextAccessor, IRequestService requestServices, ICommonActionService commonActionService)
        {
        ...
        public async Task<CommonResponseData> ActionOnCards([FromBody] ApproveCardDetailsModel approveRejectModel)
        {
            ...
            var actionOnCardsResponse = await _requestService.CommonRequestService(actionOnCardsContent, WebApiUrl.approveRejectAddOnCard);
        ...
        public async Task<ValidateAddOnCardsModel> Details(ValidateAddOnCardsModel validateNewCardsMdl)
        {
            ValidateAddOnCardsModel validateNewCardsModel = new ValidateAddOnCardsModel();
            ...
            var validateNewCardsResponse = await _requestService.CommonRequestService(validateNewCardsContent, WebApiUrl.bindPendingCustomerForAddOnCardApproval);
        ...
        public async Task<List<VehicleDetailsModel>> GetCardDetailsForApproval(string CustomerRefNo, string FormNumber)
        {
            ...
            var getDetailsForApprovalResponse = await _requestService.CommonRequestService(getDetailsForApprovalContent, WebApiUrl.getCardDetailForAddOnCardApproval);
