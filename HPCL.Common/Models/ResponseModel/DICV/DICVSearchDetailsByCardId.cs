...
{
    public class DICVSearchDetailsByCardId : ResponseMsg
    {
        public DICVCardResponse Data { get; set; }
    }

    public class DICVCardResponse
    {
        public List<DICVSearchCardResult> GetCardsDetailsModelOutput { get; set; }
        public List<DICVLimitResponseData> GetCardLimtModel { get; set; }
        public List<DICVServicesResponse> CardServices { get; set; }
    }

    public class DICVSearchCardResult
    {
    ...
    public class DICVLimitResponseData
    {
    ...
    public class DICVServicesResponse
    {
