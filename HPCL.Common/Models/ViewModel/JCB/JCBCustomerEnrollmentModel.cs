...
{
    public class JCBCustomerEnrollmentModel : BaseEntity
    {
        public JCBCustomerEnrollmentModel()
        {
            ObjJCBCardEntryDetail = new List<JCBCardEntryDetails>();
        ...
        public List<JCBCardEntryDetails> ObjJCBCardEntryDetail { get; set; }
    ...
    public class JCBCardEntryDetails
    {
