...
{
    public class DICVCustomerEnrollmentModel : BaseEntity
    {
        public DICVCustomerEnrollmentModel()
        {
            ObjDICVCardEntryDetail = new List<DICVCardEntryDetails>();
        ...
        [Required(ErrorMessage = "Customer/Org. Name is Required")]
        ...
        public List<DICVCardEntryDetails> ObjDICVCardEntryDetail { get; set; }
    ...
    public class DICVCardEntryDetails
    {
        ...
        public string DealerCode { get; set; }
        public IFormFile RCProof { get; set; }
    }
}